...
class SelectInside extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final double heights = MediaQuery
        ...
        .size
        .height;
    final double widths = MediaQuery
        .of(context)
        .size
        .width;
            ...
            appBar: AppBar(
              ...
              actions: [
                IconButton(
                  ...
                  onPressed: () {
                    if (select == 1) {
                      Get.off(OpenPlaylist(playlistId),);
                          ...
                          ListTile(
                            ...
                            trailing: IconButton(
                              ...
                              onPressed: () {
                                ...
                                final songID = trackPageController.tracks[index]
                                    .id;
                                final playlistID = playlistId;
                                final songName =
                                    trackPageController.tracks[index].title;
                                final path = trackPageController.tracks[index]
                                    .data;
                            ...
                            subtitle: Text(
                              trackPageController.tracks[index]
                                  .displayNameWOExt,
